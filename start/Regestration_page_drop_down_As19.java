package start;
/*Assignment 19 WAP on DropDown handling using "https://grotechminds.com/registration/" website for
...
public class Regestration_page_drop_down_As19 
{
	...
	public static void main(String[] args) throws InterruptedException
	{
		...
		driver.findElement(By.xpath("//input[@id = 'file']")).sendKeys("C:\\Users\\E MAX SOHAR\\Downloads\\French Revolution_Shobhit Nirwan (1).pdf");
